...
export default function Browse() {
    ...
    return (
        <div className="browse browse-single-row" data-active-row={activeRow}>
            ...
            {/* BrowseHero is the page-level hero panel from pre-t32.
                In single-row mode (t33) the focused row is centered
                vertically and there's no room for a top hero - the
                visible row's tile metadata card (t32 inline card)
                surfaces this info instead. The component still
                fetches focused-item detail as a side effect to warm
                the kid-item cache, just rendered hidden via CSS. */}
            <BrowseHero
                item={focusedItem}
