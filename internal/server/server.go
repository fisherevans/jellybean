...
func (s *Server) routes() {
	...
	admin.HandleFunc("/items/{id}", s.handleAdminGetItem).Methods(http.MethodGet)
	...
	admin.HandleFunc("/profiles/{id}/body-breaks/reset", s.handleAdminResetProfileBodyBreaks).Methods(http.MethodPost)
